  ...
  return (
    <>
      ...
      <section className="content">
        ...
        <h3>
          <a href="https://www.dropbox.com/s/97nrrwwiupiuee8/Offer_Letter_Jacob-public.pdf?dl=0">
            Full Stack Web Developer
          </a>
        </h3>
        <p>
          <a href="https://etadventures.com/">Educational Travel Adventures</a>{" "}
          | Feb 2022 – Present |{" "}
          <a href="https://goo.gl/maps/Td5mBiT62q6QarPn6">Remote</a>
        </p>
        <ul>
          <li>
            Leading technical development and support of customer facing
            websites, web applications, and mobile / hybrid applications
          </li>
          <li>
            Planning, designing, and implementing a variety of technical
            solutions across the business
          </li>
          <li>Owning projects from inception through completion</li>
        </ul>

        <h3>
          <a href="https://www.dropbox.com/s/5bmnotwzas2zco0/Web%20Programmer_Developer%20-%20Conestoga%2C%20PA%20-%20Indeed.com.pdf?dl=0">
            Web Developer and Client Support Specialist
          </a>
        </h3>
        <p>
          <a href="https://sharpinnovations.com/">Sharp Innovations</a> | Nov
          2021 – Feb 2022 |{" "}
          <a href="https://g.page/SharpInnovationsInc?share">Conestoga, PA</a>
        </p>
        <ul>
          <li>
            Developed a method for database migration which cut the process from
            hours to&nbsp;minutes using SQL and PHP
          </li>
          <li>
            Supported web customers ranging from aesthetic site revisions to
            security patches to Linux command line email&nbsp;troubleshooting
          </li>
          <li>
            Structured team work process by creating a task board to organize
            work more effectively than the previous email inbox task
            management&nbsp;system
          </li>
        </ul>
        ...
        <p>
          <a href="https://stewardgoods.com/">Steward Goods</a> | Mar 2020 – Nov
          2021 |{" "}
        ...
        <ul>
          ...
          <li>
            ...
            8.5.1&nbsp;tests, including headless WordPress sites
          </li>
          <li>
          ...
          <li>
            <a href="https://artifact-minimalism.site/">Engineered</a> a content
            management system using PHP and&nbsp;MySQL 
          </li>
          <li>
            <a href="https://15eastcreative.com">Created</a> web app to match
            company style&nbsp;guide
          </li>
          <li>
            <a href="https://coachscall.org">Produced</a> a progressive web app
            for an athletic mentoring program
          </li>
        </ul>
